...
def verify():
    ...
    return "Getting ready to drop bangers!", 200
            ...
            for messaging_event in entry["messaging"]:
                ...
                if messaging_event.get("message"):  # someone sent us a message
                    ...
                    if 'add' in message_text:
                        add_banger(message_text)
                        send_message(sender_id, count())


                    elif 'bang' in message_text:
                        send_message(sender_id, random.choice(load_bangers()))
                    elif 'count' in message_text:
                        send_message(sender_id, count())
